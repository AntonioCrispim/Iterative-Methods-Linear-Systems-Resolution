...
int main(void){
     double **D, **LU, **M, *N, *Aux, *El, p, S, SomaE, E, max, w;
     int i, j, k, cont;
...
/*-------------------------------------------------Método de Jacobi----------------------------------------------------------------- */
     ...
     matrizLU( n, LU);                   /*Chama o procedimento que calcula as diagonais*/
...
/*-----------------------------------------------------Método de Gauss-Seidel--------------------------------------------------------*/
       ...
       do{
        ...
        for(i=0; i<n; i++){                  /*Mostra os valores de xi*/
          ...
          plotGraphic("set title 'Metodos iterativos'; set xlabel 'Iteracoes'; set ylabel 'Erro'; set xrange [1:*]; plot 'GrafJ.txt' title 'Metodo de Jacobi' lt 1 w lp,\  'GrafG.txt' title 'Metodo de Gauss-Seidel' lt 2 w lp; pause 100"); 
